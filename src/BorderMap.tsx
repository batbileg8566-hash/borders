...
export function BorderMap({ borders, selectedBorder, onSelect, globalFilter, distanceMode, onDistanceModeChange }: BorderMapProps) {
  ...
  return (
    <div className="flex-1 relative h-full">
      ...
      <div className="absolute top-6 left-2 md:left-6 z-[1000] flex flex-col md:flex-row gap-2">
      ...
      {/* Map Legend Overlay */}
      <div className="absolute top-6 right-2 md:right-6 z-[1000] bg-white/90 backdrop-blur-md p-3 md:p-4 rounded-xl border border-gray-200 shadow-xl space-y-3 w-40 md:w-52 overflow-hidden max-h-[40vh] md:max-h-none overflow-y-auto">
