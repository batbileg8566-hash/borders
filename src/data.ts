...
export const borderCrossings: BorderCrossing[] = [
  ...
  { id: 'tes', name: 'Тэс', region: 'Увс', direction: 'Хойд', lat: 50.5, lng: 93.5, ubDistance: 1660, aimagDistance: 220, aimagLat: 49.98, aimagLng: 92.07, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 150 },
  { id: 'artssuuri', name: 'Арцсуурь', region: 'Завхан', direction: 'Хойд', lat: 50.3, lng: 95.8, ubDistance: 1185, aimagDistance: 385, aimagLat: 47.74, aimagLng: 96.85, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 200 },
  { id: 'burgastay', name: 'Бургастай', region: 'Говь-Алтай', direction: 'Урд', lat: 44.8, lng: 93.9, ubDistance: 1320, aimagDistance: 320, aimagLat: 46.37, aimagLng: 96.26, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 250 },
  { id: 'tsumber', name: 'Сүмбэр', region: 'Дорнод', direction: 'Зүүн', lat: 47.6, lng: 118.6, ubDistance: 1135, aimagDistance: 425, aimagLat: 48.07, aimagLng: 114.53, operationalStatus: "Олон улсын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 100 },
  { id: 'tsagaandel', name: 'Цагаандэл-Уул', region: 'Өмнөговь', direction: 'Урд', lat: 41.583, lng: 105.0, ubDistance: 770, aimagDistance: 195, aimagLat: 43.57, aimagLng: 104.42, operationalStatus: "Түр ажиллагаатай", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 200 },
];
