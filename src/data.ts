...
export const borderCrossings: BorderCrossing[] = [
  ...
  { id: 'bulgan-hovd', name: 'Булган (Ховд)', region: 'Ховд', direction: 'Баруун (Хятад)', lat: 46.1, lng: 91.1, ubDistance: 1556, aimagDistance: 400, aimagLat: 48.0, aimagLng: 91.64, operationalStatus: "Олон улсын", trafficStatus: "Ачаалалтай", transportTypes: ["Автозам"], capacity: 700 },
  { id: 'gashuunsuhayt', name: 'Гашуунсухайт', region: 'Өмнөговь', direction: 'Урд (Хятад)', lat: 42.5833, lng: 107.5833, ubDistance: 800, aimagDistance: 342, aimagLat: 43.57, aimagLng: 104.42, operationalStatus: "Олон улсын", trafficStatus: "Ачаалалтай", transportTypes: ["Автозам", "AGV"], capacity: 2500 },
  { id: 'shiveehuren', name: 'Шивээхүрэн', region: 'Өмнөговь', direction: 'Урд (Хятад)', lat: 42.7, lng: 101.4, ubDistance: 955, aimagDistance: 350, aimagLat: 43.57, aimagLng: 104.42, operationalStatus: "Олон улсын", trafficStatus: "Квот тулсан", transportTypes: ["Автозам", "AGV"], capacity: 1100 },
  { id: 'hanh', name: 'Ханх', region: 'Хөвсгөл', direction: 'Хойд', lat: 51.5, lng: 100.6, ubDistance: 1100, aimagDistance: 303, aimagLat: 49.63, aimagLng: 100.16, operationalStatus: "Түр ажиллагаатай", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 100 },
  { id: 'ereentsav', name: 'Эрээнцав', region: 'Дорнод', direction: 'Зүүн (Орос)', lat: 49.6, lng: 115.1, ubDistance: 943, aimagDistance: 245, aimagLat: 48.07, aimagLng: 114.53, operationalStatus: "Олон улсын", trafficStatus: "Хэвийн", transportTypes: ["Төмөр зам"], capacity: 400 },
  { id: 'havirga', name: 'Хавирга', region: 'Дорнод', direction: 'Зүүн (Хятад)', lat: 47.5, lng: 115.1, ubDistance: 795, aimagDistance: 135, aimagLat: 48.07, aimagLng: 114.53, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 400 },
  ...
  { id: 'tsagaannuur', name: 'Цагааннуур', region: 'Баян-Өлгий', direction: 'Баруун (Орос)', lat: 49.5, lng: 89.4, ubDistance: 1900, aimagDistance: 100, aimagLat: 48.98, aimagLng: 89.97, operationalStatus: "Олон улсын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 600 },
  { id: 'hangi', name: 'Ханги', region: 'Дорноговь', direction: 'Урд (Хятад)', lat: 42.9, lng: 110.1, ubDistance: 770, aimagDistance: 320, aimagLat: 44.8876, aimagLng: 110.1345, operationalStatus: "Хоёр талын", trafficStatus: "Ачаалалтай", transportTypes: ["Автозам"], capacity: 900 },
  { id: 'ulhan', name: 'Ульхан', region: 'Дорнод', direction: 'Зүүн', lat: 49.2, lng: 112.5, ubDistance: 740, aimagDistance: 270, aimagLat: 48.07, aimagLng: 114.53, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 200 },
  { id: 'bayanhoshuu', name: 'Баянхошуу', region: 'Дорнод', direction: 'Зүүн (Хятад)', lat: 47.2, lng: 118.8, ubDistance: 1000, aimagDistance: 340, aimagLat: 48.07, aimagLng: 114.53, operationalStatus: "Хоёр талын", trafficStatus: "Хэвийн", transportTypes: ["Автозам"], capacity: 300 },
