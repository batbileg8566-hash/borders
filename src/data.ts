...
export const borderCrossings: BorderCrossing[] = [
  ...
  { id: 'sukhbaatar', name: 'Сүхбаатар', region: 'Сэлэнгэ', direction: 'Хойд (Орос)', lat: 50.2333, lng: 106.2167, ubDistance: 310, aimagDistance: 0, status: "Хэвийн", capacity: 1200 },
  { id: 'chinggis', name: 'Чингис хаан ОУНБ', region: 'Улаанбаатар', direction: 'Агаар', lat: 47.8431, lng: 106.7644, ubDistance: 0, aimagDistance: 0, status: "Хэвийн", capacity: 5000 },
  { id: 'tsagaannuur', name: 'Цагааннуур', region: 'Баян-Өлгий', direction: 'Баруун (Орос)', lat: 49.5, lng: 89.4, ubDistance: 1900, aimagDistance: 100, status: "Ачаалалтай", capacity: 600 },
  { id: 'ereentsav', name: 'Эрээнцав', region: 'Дорнод', direction: 'Зүүн (Орос)', lat: 49.6, lng: 115.1, ubDistance: 943, aimagDistance: 245, status: "Хэвийн", capacity: 400 },
  { id: 'bulgan-hovd', name: 'Булган (Ховд)', region: 'Ховд', direction: 'Баруун (Хятад)', lat: 46.1, lng: 91.1, ubDistance: 1556, aimagDistance: 400, status: "Ачаалалтай", capacity: 700 },
  { id: 'gashuunsuhayt', name: 'Гашуунсухайт', region: 'Өмнөговь', direction: 'Урд (Хятад)', lat: 42.5833, lng: 107.5833, ubDistance: 800, aimagDistance: 342, status: "Ачаалалтай", capacity: 2500 },
  { id: 'hangi', name: 'Ханги', region: 'Дорноговь', direction: 'Урд (Хятад)', lat: 42.9, lng: 110.1, ubDistance: 770, aimagDistance: 320, status: "Хэвийн", capacity: 900 },
  { id: 'havirga', name: 'Хавирга', region: 'Дорнод', direction: 'Зүүн (Хятад)', lat: 47.5, lng: 115.1, ubDistance: 795, aimagDistance: 135, status: "Ачаалалтай", capacity: 400 },
  { id: 'shiveehuren', name: 'Шивээхүрэн', region: 'Өмнөговь', direction: 'Урд (Хятад)', lat: 42.7, lng: 101.4, ubDistance: 955, aimagDistance: 350, status: "Хэвийн", capacity: 1100 },
  { id: 'ulhan', name: 'Ульхан', region: 'Дорнод', direction: 'Зүүн', lat: 49.2, lng: 112.5, ubDistance: 740, aimagDistance: 270, status: "Хэвийн", capacity: 200 },
  { id: 'bayanhoshuu', name: 'Баянхошуу', region: 'Дорнод', direction: 'Зүүн (Хятад)', lat: 47.2, lng: 118.8, ubDistance: 1000, aimagDistance: 340, status: "Хэвийн", capacity: 300 },
  { id: 'tes', name: 'Тэс', region: 'Увс', direction: 'Хойд', lat: 50.5, lng: 93.5, ubDistance: 1660, aimagDistance: 220, status: "Хэвийн", capacity: 150 },
  { id: 'artssuuri', name: 'Арцсуурь', region: 'Завхан', direction: 'Хойд', lat: 50.3, lng: 95.8, ubDistance: 1185, aimagDistance: 385, status: "Хэвийн", capacity: 200 },
  { id: 'burgastay', name: 'Бургастай', region: 'Говь-Алтай', direction: 'Урд', lat: 44.8, lng: 93.9, ubDistance: 1320, aimagDistance: 320, status: "Хэвийн", capacity: 250 },
  { id: 'hanh', name: 'Ханх', region: 'Хөвсгөл', direction: 'Хойд', lat: 51.5, lng: 100.6, ubDistance: 1100, aimagDistance: 303, status: "Хэвийн", capacity: 100 },
  { id: 'yarant', name: 'Ярант (Даян)', region: 'Ховд', direction: 'Баруун', lat: 46.7, lng: 90.9, ubDistance: 1890, aimagDistance: 212, status: "Хэвийн", capacity: 200 },
  { id: 'baytag', name: 'Байтаг', region: 'Ховд', direction: 'Баруун', lat: 45.1, lng: 91.0, ubDistance: 1600, aimagDistance: 550, status: "Хэвийн", capacity: 150 },
  { id: 'tsumber', name: 'Сүмбэр', region: 'Дорнод', direction: 'Зүүн', lat: 47.6, lng: 118.6, ubDistance: 1135, aimagDistance: 425, status: "Хэвийн", capacity: 100 },
  { id: 'tsagaandel', name: 'Цагаандэл-Уул', region: 'Өмнөговь', direction: 'Урд', lat: 43.2, lng: 106.3, ubDistance: 770, aimagDistance: 195, status: "Квот тулсан", capacity: 200 },
];
